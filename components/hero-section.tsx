...
export function HeroSection() {
  return (
    <section className="pt-6 pb-8 px-4 lg:pt-24 lg:pb-12 lg:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2 lg:gap-8 mb-8 lg:mb-12">
          {/* Left side - Hero text */}
          <div className="flex flex-col justify-center text-center lg:text-left">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-6 lg:mb-8 text-balance">
              World's Largest Online Casino and Sportsbook
            </h1>

            <Button className="bg-[#2563eb] hover:bg-[#1d4ed8] text-white mx-auto lg:mx-0 w-full sm:w-fit px-8 py-6 text-base lg:text-lg mb-6">
              Register
            </Button>
            ...
            <div className="flex flex-col items-center lg:items-start gap-4">
              ...
              <div className="flex gap-3 justify-center lg:justify-start">
                <button className="w-12 h-12 rounded-lg bg-[#2a3c48] hover:bg-[#3a4c58] flex items-center justify-center transition-colors">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-3 lg:p-4">
                    <div className="flex flex-col gap-1 text-white">
                      <div className="flex items-center gap-2">
                        <Dice5 className="w-4 h-4 lg:w-5 lg:h-5" />
                        <span className="font-semibold text-sm lg:text-base">Casino</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
                        <span className="text-xs lg:text-sm">57,349</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-3 lg:p-4">
                    <div className="flex flex-col gap-1 text-white">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-semibold text-sm lg:text-base">Sports</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
                        <span className="text-xs lg:text-sm">18,571</span>
                      </div>
                    </div>
                  </div>
                </div>
